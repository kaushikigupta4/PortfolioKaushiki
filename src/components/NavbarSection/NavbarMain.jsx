...
const NavbarMain = () => {
  ...
  return (
   <nav className=" fixed w-full left-[50%] -translate-x-[50%] z-20 flex gap-4 px-5 z-20">
    ...
    <div className="flex justify-center items-center sm:block md:hidden lg:hidden  block p-5 rounded-full bg-[#C1C7F9]">
