...
const NavbarLink = () => {
  return (
    <div className="flex flex-col md:flex-row w-full gap-6 font-bold py-2 text-xl md:relative absolute top-[110%] left-[50%] -translate-x-[50%] text-center bg-[#F8A49B]/40 backdrop-blur-md sm:shadow-lg md:bg-transparent md:backdrop-blur-none md:shadow-none ">
      {
