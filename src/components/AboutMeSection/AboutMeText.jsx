const AboutMeText = () => {
  return (
    <div className="flex flex-col items-center lg:items-start text-center md:text-left w-full md:max-w-full mx-auto bg-[#E7F8FF] p-6 sm:p-10 md:p-12 shadow-xl rounded-lg">

      
      <h1 className="text-4xl md:text-4xl lg:text-6xl font-bold text-[#333]">
        About Me
      </h1>

      <p className="text-gray-600 mt-4 text-base sm:text-lg md:text-md leading-relaxed">
      ...
      <p className="text-gray-600 mt-4 sm:mt-5 text-base sm:text-lg md:text-md leading-relaxed">
      ...
      <p className="hidden sm:block text-gray-600 mt-4 sm:mt-5 text-base sm:text-lg md:text-md leading-relaxed">
